...
copyright = u'2019, Matthew Jones, Alex Khodaverdian, Jeffrey Quinn'
...
latex_documents = [
    (master_doc, 'Cassiopeia.tex', u'Cassiopeia Documentation',
     u'Matthew Jones, Alex Khodaverdian, Jeffrey Quinn', 'manual'),
]
...
man_pages = [
    (master_doc, 'cassiopeia', u'Cassiopeia Documentation',
     [author], 1)
]
