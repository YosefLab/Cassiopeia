...
class TestSmallParsimony(unittest.TestCase):
    def setUp(self):
        ...
        basic_meta = pd.DataFrame.from_dict({
            ...
            "13": ["G", 8],
            "14": ["G", 9],
        }, orient='index', columns=['nucleotide', 'quality'])
    ...
    def test_fitch_hartigan_bottom_up(self):
        ...
        self.assertRaises(CassiopeiaError, fitch_hartigan_bottom_up, self.binary_tree, "quality")
        self.assertRaises(CassiopeiaError, fitch_hartigan_bottom_up, self.binary_tree, "imaginary_column")
    ...
    def test_score_parsimony(self):
        ...
        self.assertRaises(CassiopeiaError, cas.tl.score_small_parsimony, self.binary_tree, "nucleotide", None, False, "label")
        ...
        fitch_tree = cas.tl.fitch_hartigan(self.binary_tree, "nucleotide", label_key = 'inferred_nucleotide', copy=True)
        parsimony = cas.tl.score_small_parsimony(fitch_tree, "nucleotide", infer_ancestral_states=False, label_key = "inferred_nucleotide")
        self.assertEqual(parsimony, 3)
