...
class TestCassiopeiaTree(unittest.TestCase):
    ...
    def test_uninitialized_tree_raises_error(self):
        r"""Methods of the CassiopeiaTree that operate on the tree (as opposed to,
    ...
    def test_cache_internals_not_exposed(self):
        r"""The CassiopeiaTree should not expose the lists in the cache. It should
        only return copies.
        """
        tree = cas.data.CassiopeiaTree(tree=self.test_network)
        for method in [
    ...
    def test_tree_topology_not_exposed(self):
        r"""When the CassiopeiaTree is created with a networkx.DiGraph object, a
