...
def test_to_newick_tree_format():
    ...
    tree.set_edge_lengths(
        [(0, 1, 0.1), (1, 2, 0.5), (1, 3, 0.2), (3, 4, 0.3), (3, 5, 0.4)]
    )
    tree.set_states(
        [
            (0, "0000000000"),
    ...
    assert (
        res == "((_1111000000:0.5,(_1110000111:0.3,_1110111111:0.4)"
    ...
    res = tree.to_newick_tree_format(
        print_internal_nodes=True, add_N_to_node_id=True
    )
    ...
    assert (
        res == "((N2_1111000000:0.5,(N4_1110000111:0.3,N5_1110111111:0.4)"
    ...
    assert (
        res == "((N2:0.5[&&NHX:muts=0.33],(N4:0.3[&&NHX:muts=0.43],"
