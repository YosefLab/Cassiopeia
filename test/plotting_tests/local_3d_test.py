...
class TestLocal3DPlotting(unittest.TestCase):
    ...
    def test_average_mixing(self):
        ...
        c2 = (0.1, 0.2, 0.3)
        c3 = (0.5, 0.7, 0.0)
        np.testing.assert_allclose((0.2, 0.3, 0.1), local_3d.average_mixing(c1, c2, c3))

    def test_highlight(self):
        c = (0.8, 0.2, 0.0)
        np.testing.assert_allclose((1.0, 0.25, 0.), local_3d.highlight(c))

    def test_lowlight(self):
        c = (0.8, 0.2, 0.0)
        np.testing.assert_allclose((0.3, 0.075, 0.), local_3d.lowlight(c))
